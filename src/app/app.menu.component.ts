...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Analytics', icon: 'pi pi-fw pi-chart-line', routerLink: ['/uikit'],
                items: [
            ...
            // },
            {
                label: 'Manage', icon: 'pi pi-fw pi-copy', routerLink: ['/pages'],
                items: [
                    {label: 'Users', icon: 'pi pi-fw pi-users', routerLink: ['/pages/users']},
                    {label: 'Wallet', icon: 'pi pi-fw pi-credit-card', routerLink: ['/pages/wallet']},
